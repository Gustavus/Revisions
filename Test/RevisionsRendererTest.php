...
//   <label><input class='revisionsAction' type='radio' name='revisionsAction' value='textDiff' checked='true'/>Text and Diff</label>
//   <label><input class='revisionsAction' type='radio' name='revisionsAction' value='text'/>Text</label>
//   <label><input class='revisionsAction' type='radio' name='revisionsAction' value='diff'/>Diff</label>
...
//     <td><input id='oldNum-4' type='radio' name='oldRevisionNumber' class='compare' value='4' /></td>
//     <td><input id='newNum-4' type='radio' name='newRevisionNumber' class='compareAgainst' value='4' /></td>
//     <td>$now</td>
//     <td></td>
//     <td></td>
//     <td>age, name</td>
...
//     <td><input id='oldNum-3' type='radio' name='oldRevisionNumber' class='compare' value='3' /></td>
//     <td><input id='newNum-3' type='radio' name='newRevisionNumber' class='compareAgainst' value='3' /></td>
//     <td>$now</td>
//     <td></td>
//     <td></td>
//     <td>age</td>
...
//     <td><input id='oldNum-2' type='radio' name='oldRevisionNumber' class='compare' value='2' /></td>
//     <td><input id='newNum-2' type='radio' name='newRevisionNumber' class='compareAgainst' value='2' /></td>
//     <td>$now</td>
//     <td></td>
//     <td></td>
//     <td>name</td>
...
//     <td><input id='oldNum-1' type='radio' name='oldRevisionNumber' class='compare' value='1' /></td>
//     <td><input id='newNum-1' type='radio' name='newRevisionNumber' class='compareAgainst' value='1' /></td>
//     <td>$now</td>
//     <td></td>
//     <td></td>
//     <td>name</td>
...
//     <td><input id='oldNum-5' type='radio' name='oldRevisionNumber' class='compare' value='5' /></td>
//     <td><input id='newNum-5' type='radio' name='newRevisionNumber' class='compareAgainst' value='5' /></td>
//     <td>$now</td>
//     <td></td>
//     <td></td>
//     <td>age, name</td>
